Welcome to the **Intro to Cloud Part 2** course! In this workshop, you'll build off of the  key cloud concepts covered in the first workshop!
...
- Core Components and Best Practices  IAM
- The Principle of Least Privilege
- Understanding the Terraform Architecture
- Networking basics & Security Groups 
- Networking in Terraform
- Load Balancing Fundamentals
- Event-Driven Architecture Concepts and Lambda Fundamentals
