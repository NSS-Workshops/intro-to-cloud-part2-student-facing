...
**Most of you should have already received this email in Cloud Workshop 1 in which case your user is already verified and you won't receive another email for this course.**
...
then select the **`intro_to_cloud_2`** link
